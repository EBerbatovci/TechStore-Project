        ...
        <Modal.Body>
          <Form>
            ...
            <Form.Group className="mb-3" controlId="formGridAddress2">
              ...
              <Form.Control placeholder="045123123 ose +38345124132" value={perdoruesi && perdoruesi.teDhenatPerdoruesit && perdoruesi.teDhenatPerdoruesit.nrKontaktit} onChange={(e) => handleNumriChange(e.target.value)} />
            </Form.Group>
            <Row>
              <Form.Group as={Col} className="p-0" controlId="formGridCity">
                <Form.Label>Adresa<span style={{ color: "red" }}>*</span></Form.Label>
                <Form.Control placeholder="Rruga Nënë Tereza 10" value={perdoruesi && perdoruesi.teDhenatPerdoruesit && perdoruesi.teDhenatPerdoruesit.adresa} onChange={(e) => handleAdresaChange(e.target.value)} />
              </Form.Group>
              <Form.Group as={Col} className="p-0" controlId="formGridCity">
                <Form.Label>Qyteti<span style={{ color: "red" }}>*</span></Form.Label>
                <Form.Control placeholder="Lipjan" value={perdoruesi && perdoruesi.teDhenatPerdoruesit && perdoruesi.teDhenatPerdoruesit.qyteti} onChange={(e) => handleQytetiChange(e.target.value)} />
              </Form.Group>
            </Row>
